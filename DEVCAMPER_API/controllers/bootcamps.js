...
exports.getBootcamps = async (req, res, next) => {
    ...
    try {
        ...
        const bootcamres = await Bootcamp.find()

        res.status(200).json({
            success: true, count: bootcamres.length, data: bootcamres
        })
...
exports.updateBootcamp = async (req, res, next) => {
    ...
    try {
        const bootcamp = await Bootcamp.findByIdAndUpdate(req.params.id, req.body, { // this id is coming from routes...
            new: true,
            runValidators: true
        })
